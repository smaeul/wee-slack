...
class SlackRequest(object):
    ...
    def __init__(self, token, request, post_data={}, **kwargs):
        ...
        self.response_id = hash_hex("{}{}".format(self.url, self.start_time))
...
#        return "URL: {} Tries: {} ID: {}".format(self.url, self.tries, self.response_id)
    ...
    def tried(self):
        self.tries += 1
        self.response_id = hash_hex("{}{}".format(self.url, time.time()))
...
class SlackTeam(object):
    ...
    def generate_team_hash(nick, subdomain):
        return str(hash("{}{}".format(nick, subdomain)))
